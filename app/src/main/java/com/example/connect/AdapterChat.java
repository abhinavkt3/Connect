...
public class AdapterChat extends RecyclerView.Adapter<com.example.connect.AdapterChat.Myholder> {
    ...
    public AdapterChat(FragmentActivity activity, List<ModelUsers> usersList) {
    }
